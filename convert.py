...
# Cloudflare error codes meaning the origin (wdgwars.pl) is unreachable —
# generated by Cloudflare itself, not the application. 503 is included because
# Cloudflare emits it when the origin is overloaded or returning errors before
# Cloudflare can distinguish whose fault it is.
_CF_ORIGIN_DOWN = frozenset(range(520, 528)) | {503}
